...
+          <h1 className="text-xl lg:text-2xl font-bold text-white mb-2">Analytics</h1>
+          <p className="text-sm lg:text-base text-gray-400">Insights and analytics for your family data</p>
         </div>
         
-        <button className="flex items-center space-x-2 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">
+        <button className="flex items-center space-x-2 px-4 py-3 lg:py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors touch-manipulation">
...
+                  className={`flex items-center space-x-2 px-4 lg:px-6 py-4 text-sm font-medium transition-colors whitespace-nowrap touch-manipulation ${
                     activeTab === tab.id
